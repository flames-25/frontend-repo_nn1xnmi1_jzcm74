...
export default function MusicPlayer() {
  ...
  const track = {
    ...
    // Royalty-free music hosted on Pixabay CDN
  ...
  return (
    <div className="backdrop-blur-md/60 bg-white/10 border border-white/10 rounded-xl p-3 sm:p-4 shadow-lg flex items-center gap-3 text-white">
